...
from app.security import get_token,user_auth,black_token, check_permissions,ActionEnum as Act,ResourceEnum as Res

router = APIRouter(prefix="/users",tags=["Users"])

@router.patch("/change_me")
def change_me(new_data:UserUpdateSchema,
...
@router.get("/me")
def get_me(user:UserTokenDataSchema = Depends(get_token),
...
@router.delete("/me")
def delete_me(user:UserTokenDataSchema = Depends(get_token),
              b_token:str = Depends(user_auth),
